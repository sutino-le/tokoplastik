...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table style="width: 100%;" id="datatabelsatuan"
...
<script>
    function listDataSatuan() {
        var table = $('#datatabelsatuan').dataTable({
            destroy: true,
            "processing": true,
            "serverSide": true,
            "order": [],
            "ajax": {
                "url": "<?= base_url() ?>listDataSatuan",
                "type": "POST",
            },
            columnDefs: [{
                    orderable: false,
    ...
    function hapus(katid) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= base_url() ?>satuanHapus/" + katid,
                    dataType: "json",
                    success: function(response) {
                        if (response.sukses) {
                            swal.fire(
