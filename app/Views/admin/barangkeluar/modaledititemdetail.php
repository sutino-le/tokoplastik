...
<div class="modal fade" id="modalEditItem" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>modalEditItemBarangKeluarDetailSimpan" class="tomboledititemsimpan" id="tomboledititemsimpan"
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="detinvoice" id="detinvoice" value="<?= $detinvoice ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('.tomboledititemsimpan').submit(function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= base_url() ?>modalEditItemBarangKeluarDetailSimpan',
                data: formData,
                contentType: false,
                processData: false,
                dataType: "json",
