...
<div class="modal fade" id="modalTambah" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>wilayahTambahSimpan" class="formsimpan">
                <?= csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="kelurahan" id="kelurahan" class="form-control" placeholder="Masukan Kelurahan..." autocomplete="off">
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="kecamatan" id="kecamatan" class="form-control" placeholder="Masukan kecamatan..." autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="kota_kabupaten" id="kota_kabupaten" class="form-control" placeholder="Masukan Kota/Kabupaten..." autocomplete="off">
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="propinsi" id="propinsi" class="form-control" placeholder="Masukan Propinsi..." autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="kodepos" id="kodepos" class="form-control" placeholder="Masukan Kode POS..." autocomplete="off">
