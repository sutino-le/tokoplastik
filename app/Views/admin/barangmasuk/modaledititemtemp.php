...
<div class="modal fade" id="modalEditItem" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>modalEditItemBarangMasukSimpan" class="tomboledititemsimpan" id="tomboledititemsimpan"
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="dethargamasuk" id="dethargamasuk" value="<?= $dethargamasuk ?>">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback errorProdukNama"></div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.tomboledititemsimpan').submit(function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= base_url() ?>modalEditItemBarangMasukSimpan',
                data: formData,
                contentType: false,
                processData: false,
                dataType: "json",
